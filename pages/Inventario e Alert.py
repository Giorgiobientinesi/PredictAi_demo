...
if st.session_state['Light'] == 'red':
    ...
    giacenze['Quantità_giacenza'] = giacenze['Quantità_giacenza'].astype(str).str.replace(',', '.').astype(float).astype(int)
    ...
    df_prossimo_mese_giacenze = df_prossimo_mese_giacenze.drop_duplicates(subset="Articolo")
